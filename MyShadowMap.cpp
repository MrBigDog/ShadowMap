...
int main()
{
	...
	osg::Vec3 light_pos = osg::Vec3(0.0, 10.0, 6.0);
	...
	//osg::Matrix m = viewer->getCamera()->getInverseViewMatrix() * light_view_matrix * light_project_matrix;
	//osg::ref_ptr<osgShadow::ConvexPolyhedron> cp = new osgShadow::ConvexPolyhedron;
	//osg::BoundingBox bb = cp->computeBoundingBox( light_view_matrix*light_project_matrix*m );
	...
	// RTT frustum:
	{
		...
		osg::Matrixd MVP = light_view_matrix * light_project_matrix; //params._rttProjMatrix;
